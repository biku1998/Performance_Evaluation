...
<%
ArrayList<Student> allStudent = (ArrayList<Student>)session.getAttribute("all_Student");
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">{ All Students using the platform }</h1>
                </div>
            </div>

            <!-- ... Your content goes here ... -->
            <form action="deleteSelectedStudent" method="POST">
            ...
            <table class="responstable">
					  ...
					  <%for (Student  i: allStudent) {%>
						  <tr>
						    <td><input type="checkbox" name="stu_email" value="<%=i.getEmail()%>"/></td>
						    <td><%=i.getEmail()%></td>
						    <td><%=i.getName()%></td>
						    <td><%=i.getCity()%></td>
						    <td><%=i.getEducation()%></td>
						    <td><%=i.getGender()%></td>
						    <td><%=i.getPassout()%></td>
						    </tr>
						  <%
                ...
                <input type="submit" value="Delete Students"  name="search" class="btn btn-block btn-success"
                style='width: 200px;'
                 >
                </form>
